...
sudo apt update && apt install -y \
	git autoconf gcc libc6 make wget unzip apache2 apache2-utils php libgd-dev  \ # Nagios Core
    libmcrypt-dev libssl-dev bc gawk dc build-essential snmp libnet-snmp-perl gettext \ # Nagios Plugins
	iptables-persistent && \
